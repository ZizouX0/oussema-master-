---
name: sharing-skills
description: Contribute skills back to upstream via branch and PR. Use when you've developed a broadly useful skill and want to contribute it upstream via pull request.

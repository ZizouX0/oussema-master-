...
See test-driven-development-tdd for the fundamental RED-GREEN-REFACTOR cycle. This skill adapts TDD to documentation.
...
- ❌ Bad: `@../test-driven-development-tdd/SKILL.md` (force-loads, burns context)
...
See test-driven-development-tdd for why this matters. Same principles apply to documentation.

...
description: Maintain skills wiki health - check links, naming, cross-references, and coverage. Use when adding, removing, or reorganizing skills, or periodically to maintain wiki health and validate links.
